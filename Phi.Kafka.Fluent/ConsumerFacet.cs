...
{
    internal class ConsumerFacet : IConsumerFacet
    {
        ...
        Action<IConsumerFinalizerListFacet> _finalizerListAssembler = NoOpFactory.NoOp<IConsumerFinalizerListFacet>();

        IConsumerFacet IConsumerFacet.SetIdentity(Action<IIdentityFacet> assembler)
        {
            _identityAssembler = assembler ?? throw new ArgumentNullException(nameof(assembler));
            return this;
        }

        IConsumerFacet IConsumerFacet.SetAutoCommit(Action<IAutoCommitFacet> assembler)
        {
            _autoCommitAssembler = assembler ?? throw new ArgumentNullException(nameof(assembler));
            return this;
        }

        IConsumerFacet IConsumerFacet.SetBrokers(Action<IBrokerListFacet> assembler)
        {
        ...
        IConsumerFacet IConsumerFacet.SetCustom(Action<ICustomFacet> assembler)
        {
            _customAssembler = assembler ?? throw new ArgumentNullException(nameof(assembler));
            return this;
        }

        IConsumerFacet IConsumerFacet.SetFinalizers(Action<IConsumerFinalizerListFacet> assembler)
        {
            _finalizerListAssembler = assembler ?? throw new ArgumentNullException(nameof(assembler));
            return this;
        }
        IConsumerFacet IConsumerFacet.SetDebug(Action<IDebugFacet> assembler)
        {
            _debugAssembler = assembler ?? throw new ArgumentNullException(nameof(assembler));
            return this;
        }

        public Consumer ValidateAndBuild()
        {
